...
| `session_host_idle_minutes` | `60` | whole minutes a [background session](background-sessions.md) may sit idle with no terminal before its host stops; `0` never stops |
